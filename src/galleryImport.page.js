...
import { Button, Image, View, StyleSheet, Text, ScrollView, TouchableOpacity, Dimensions } from 'react-native';
                    ...
                    <View style={styles.container}>
                        {!image3.uri ? (
                            <View style={{flex:1,heigh:"150",flexDirection:"row", justifyContent:"center",alignItems:"center",}}>
                                <View style={{width:winWidth/2+75, height: 150,justifyContent:"flex-start",alignItems:"flex-end"}}>
                                ...
                                <View style={{width:winWidth/2-75, height: 150, justifyContent:"flex-end"}}>
